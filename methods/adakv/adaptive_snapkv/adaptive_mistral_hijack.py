...
from methods.adakv.adaptive_snapkv.snapkv_utils import init_adaptive_snapkv, DynamicCacheSplitHeadFlatten
...
def adaptive_mistral_flash_attn2_forward(
    ...
    **kwargs,
    ...
    if is_prefill:  # [SnapKV] add kv_cluster
            # [RKV] register kv_cluster
