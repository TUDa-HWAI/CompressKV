...
from methods.adacompresskv.adaptive_compresskv.snapkv_utils import init_adaptive_compresskv, DynamicCacheSplitHeadFlatten
...
def adaptive_qwen2_model_forward(
    self,
